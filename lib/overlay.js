...
central_play_icon.src = "./assets/play_button.svg";

const play_button = new Image(BUTTON_SIZE, BUTTON_SIZE);
play_button.src = "./assets/play.png";
...
volume_button.src = "./assets/volume-medium.png";
const muted_button = new Image(BUTTON_SIZE, BUTTON_SIZE);
muted_button.src = "./assets/volume-muted.png";
